...
namespace AdventOfCodeLib.XmasWordChecker
{
    ...
    //  M A M M M X M M M M
    //M X M X A X M A S X
    public class LeftDiagonalXmasWordChecker: VerticalXmasWordChecker
    {
        public LeftDiagonalXmasWordChecker(int lengthOfFile, int widthOfFile): 
        ...
        {
            return base.AddToSequence(currentChar, base.LineNumber + 1, base.WidthOfFile + base.LineNumber);
        }
    }
}
